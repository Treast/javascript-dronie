      ...
      var b = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        ...
        g = function(a, b, c, d, e, f, h, i, j, k, l) {
          ...
          return (
            ...
            (B + C) * (B + C) > j * (z * z + A * A) &&
              ((m = k.length), g(a, b, n, o, t, u, x, y, j, k, l), g(x, y, v, w, r, s, h, i, j, k, l + 1 + (k.length - m))),
            k
          );
        },
        h = function(a) {
        ...
        j = function(a, b, c) {
          ...
          var d,
            ...
            g = a.length,
            h = 1 / (+a[g - 2] + e),
            j = -b || (Math.abs(+a[g - 1] - +a[1]) < 0.01 * (+a[g - 2] - +a[0]) ? i(a) + f : +a[g - 1] + f);
            ...
            (o = u[l]),
              ...
              o.x > p.x || (p.y !== o.y && p.x === o.x) || o === p
                ? ((p.cx = o.x - p.x),
                  ...
                  p.cx < t &&
                    (p.cx ? (t = p.cx) : ((p.cx = 0.001), l === d - 1 && ((p.x -= 0.001), (t = Math.min(t, 0.001)), (this.fast = !1)))))
                : (u.splice(l--, 1), d--);
